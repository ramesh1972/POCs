...
// ================================================================================
function set_section_current_dimension(section) // dunit
{
	...
	if (section != null && section.is_sized)
		return;
...
function set_section_children_current_position(section)
{
    ...
    set_non_docked_children_current_position(section); // undunit
...
//		set_section_dimension(the_center_child, mx, my, mr-mx, mb-my);		undunit
