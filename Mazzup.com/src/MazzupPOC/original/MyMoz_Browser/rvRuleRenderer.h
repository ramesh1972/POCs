...
public:
	...
	nsresult FinishedLoadingAlertDocument();
	nsresult ProcessPickMeCommand(nsIDOMElement* p_matched_html_node, nsIDOMElement* p_processed_rule_node, PRBool p_content_has_changed);
};
