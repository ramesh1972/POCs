...
export enum SystemCommand {
    ...
    // ----------------- Data Messages -----------------
    SYS_CMD_INITIATE_DATA_CONNECTION = 'initiate-data-connection',
    SYS_CMD_INITIATED_DATA_CONNECTION = 'data-connection-initiated',
    SYS_CMD_DATA_CONNECTION_STARTED = 'data-connection-started',
    SYS_CMD_DATA_CONNECTION_STOPPED = 'data-connection-stopped',
