...
public:
	...
	II_RESULT LoadDocument(nsAutoString url);

	// The parse driver routine. Call this if you want to parse a html document to find a node!
	...
	PRFloat64 ProcessRule_MatchContent(nsIDOMElement* p_rule_node, nsIDOMElement* p_dom_node, II_RESULT &result);
