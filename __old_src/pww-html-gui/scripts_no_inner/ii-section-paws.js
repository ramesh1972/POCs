...
function create_dock_paw(section, pos)
{
	...
	var bsection = create_abstract_section(section, id, "none");
	if (bsection == null)
		return null;
...
function show_tab_bar_tab_dock_paw(tab_bar)
{
	...
	var last_tab = tab_bar.child_sections[tab_bar.child_sections.length-1];
...
function show_container_dock_paws(section, container, show_tab_paws, show_stick_paws)
{
	...
	var container_parent = get_parent(container);
