...
nvd registerc()
{
	...
	/*construct* dcons = __processor::__instructions::pi_register_construct_type("data_construct", get_data, "ddp_fp_dvp", root);
	construct* vcons  = __processor::__instructions::pi_register_construct_type("variable", get_var, "dvrp_fp_dvp", root);
	construct* mcons  = __processor::__instructions::pi_register_construct_type("method", get_mth, "dmp_fp_dvp", root);
	construct* lcons  = __processor::__instructions::pi_register_construct_type("link", get_lnk, "dlp_fp_dvp", root);
	construct* cccons = __processor::__instructions::pi_register_construct_type("collection_construct", get_collection_cons, "dccp_fp_dvp", root);

	// data types
	__processor::__instructions::pi_register_construct_type("dvp", get_dvp, "dvp_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dfp", NULL, "dfp", dcons);
	__processor::__instructions::pi_register_construct_type("dint", get_dint, "nint_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dstr", get_dstr, "nstr_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dchrp", get_dchrp, "nchrp_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dbln", get_dbln, "nbln_fp_dvp", dcons);

	// link types
	__processor::__instructions::pi_register_construct_type("link_data", NULL, "", lcons);
	__processor::__instructions::pi_register_construct_type("link_function", NULL, "", lcons);
	construct* rclink = __processor::__instructions::pi_register_construct_type("link_related_construct", NULL, "", lcons);
		__processor::__instructions::pi_register_construct_type("link_link_data", NULL, "", rclink);
		__processor::__instructions::pi_register_construct_type("link_rc_encapsulation", NULL, "", rclink);
		__processor::__instructions::pi_register_construct_type("link_rc_inhertiance", NULL, "", rclink);
		__processor::__instructions::pi_register_construct_type("link_rc_container", NULL, "", rclink);
		__processor::__instructions::pi_register_construct_type("link_rc_reference", NULL, "", rclink);
		__processor::__instructions::pi_register_construct_type("link_rc_composition", NULL, "", rclink);
		__processor::__instructions::pi_register_construct_type("link_rc_aggregation", NULL, "", rclink);
		construct* rclink_e = __processor::__instructions::pi_register_construct_type("link_rc_extension", NULL, "", rclink);
			__processor::__instructions::pi_register_construct_type("link_rc_extension_runtime_derivation", NULL, "", rclink_e);

	// variable types
	__processor::__instructions::pi_register_construct_type("param_variable", NULL, "", vcons);

	// method types
	// none ....

	// stage 2
	construct* objcons = __processor::__instructions::pi_register_construct_type("object_construct", NULL, "dfp", root);
	construct* clscons = __processor::__instructions::pi_register_construct_type("class_construct", NULL, "dfp", root);

	__processor::__instructions::pi_register_construct_type("dobj", get_dbln, "nbln_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dptr", get_dbln, "nbln_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dptrptr", get_dbln, "nbln_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("ddptrptr", get_dbln, "nbln_fp_dvp", dcons);

	__processor::__instructions::pi_register_construct_type("link_object", NULL, "", lcons);
	__processor::__instructions::pi_register_construct_type("link_object_data", NULL, "", lcons);
	__processor::__instructions::pi_register_construct_type("link_object_function", NULL, "", lcons);

	// collection types
	__processor::__instructions::pi_register_construct_type("data_collection", NULL, "", cccons);
	__processor::__instructions::pi_register_construct_type("dstr_collection", NULL, "", cccons);
	__processor::__instructions::pi_register_construct_type("dobj_collection", NULL, "", cccons);
	__processor::__instructions::pi_register_construct_type("dptr_collection", NULL, "", cccons);
	__processor::__instructions::pi_register_construct_type("dptrptr_collection", NULL, "", cccons);

	// stage 3
//	__processor::__instructions::pi_register_construct_type("dcons", get_dcons, "dcons_fp_dvp", dobj);
//	__processor::__instructions::pi_register_construct_type("dvars", get_dvar, "dvar_fp_dvp", dcons);

	__processor::__instructions::pi_register_construct_type("link_construct", NULL, "", lcons);
	__processor::__instructions::pi_register_construct_type("link_variable", NULL, "", lcons);
	__processor::__instructions::pi_register_construct_type("link_method", NULL, "", lcons);
	__processor::__instructions::pi_register_construct_type("link_context", NULL, "", lcons);
	__processor::__instructions::pi_register_construct_type("link_collection", NULL, "", lcons);
*/
	// stage 4
...
/*	__processor::__instructions::pi_register_construct_type("dxmldoc", get_dcons, "dcons_fp_dvp", dobj);
	__processor::__instructions::pi_register_construct_type("dxmlnode", get_dcons, "dcons_fp_dvp", dobj);
	__processor::__instructions::pi_register_construct_type("dxmlvalue", get_dcons, "dcons_fp_dvp", dobj);
	__processor::__instructions::pi_register_construct_type("dxmlnodes", get_dcons, "dcons_fp_dvp", dobj);

	__processor::__instructions::pi_register_construct_type("ddb", get_dvar, "dvar_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dtable", get_dvar, "dvar_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("drecordset", get_dvar, "dvar_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("drecord", get_dvar, "dvar_fp_dvp", dcons);
	__processor::__instructions::pi_register_construct_type("dcell", get_dvar, "dvar_fp_dvp", dcons);

	__processor::__instructions::pi_register_construct_type("xml_collection", NULL, "", cccons);
	__processor::__instructions::pi_register_construct_type("records_collection", NULL, "", cccons);
*/

	// stage 5
//	construct* intptcons = __processor::__instructions::pi_register_construct_type("interrupt_construct", NULL, "dfp", root);
...
/*	__processor::__instructions::register_method("register_constructs", "method", defaults, register_constructs, "nvp_fp");
	__processor::__instructions::register_method("user_init", "method", defaults, user_init, "nvp_fp");
	__processor::__instructions::register_method("user_process", "method", defaults, user_process, "nvp_fp");
	__processor::__instructions::register_method("user_clean", "method", defaults, user_clean, "nvp_fp");*/
}
