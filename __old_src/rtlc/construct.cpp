																				...
																				nstr scope, nstr order)
{
	...
	rel_construct* rel = (rel_construct*) __instructions::ci_create_construct(rel_name, rel_type, parent_rel, scope, order);

	// create the relative
	construct* reltive = __instructions::ci_create_construct(referee_name, referee_type, rel);
