...
// VERY USEFUL MACROS ====================================================
#define $PI_PROC __language::__processor::processor::p()
#define $PI_DISP __language::__processor::processor::d()
#define $PI_MEM  __language::__processor::processor::m()
#define $PI_LNK  __language::__processor::processor::l()

// helper macros =====================================================
#define $PI_MEM_P $MEM->_proc_m
#define $PI_MEM_C(Rc, Rct) (__language::__processor::__instructions::pi_get_root_mem_section(#Rc, #Rct))
#define $PI_MEM_DMPC(C) C->dump_construct_data();
#define $PI_MEM_DMPT(C) C->dump_construct_data(true);
#define $PI_MEM_DMP __language::__processor::__instructions::pi_dump_memory();
...
class linker;
namespace __linker {class linker_object;} // THE MOST IMPORTANT CLASS IN THIS WHOLE LIB.
