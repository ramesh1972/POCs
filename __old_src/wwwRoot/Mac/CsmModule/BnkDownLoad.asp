...
<%
		...
		lResult = lObjBnkDownLoad.DoDownloadExch(lStartDate,"1900-01-01:00:00:00.000001","V",lResponse)
		
		separator = split(lResponse,"$")
		Const ForReading = 1, ForWriting = 2, ForAppending = 8
		
		Set lFileSystemObject = CreateObject("Scripting.FileSystemObject")
		Set lRsFileSystemObject = lFileSystemObject.OpenTextFile("c:\inetpub\wwwroot\mac\DownLoad-" & replace(date,"/","-") & ".txt",ForWriting,true)
	...
	<tr  width="40%"><td class=tdbgdark><font class=whiteboldtext>Exchange Down Load  Details</font></td></tr>
	<tr width="40%"><td class=tdbglight>
	<font class=colorboldtext1>The Exchange Down load details has downloaded.Click <a href="MacClearingSettlement.asp">here</a> to view the previous page</font>
	</td></tr>
	</table>
	<P>&nbsp;</P>
