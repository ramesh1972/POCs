...
%>		
	...
	function FunctionPrevious()
	{
		...
		document.FrmBnkDownLoadBrowse.action="WBnkDownLoadRes.asp";
	...
	{
		document.FrmBnkDownLoadBrowse.method="post";
		document.FrmBnkDownLoadBrowse.action="WBnkDownLoad.asp";
		document.FrmBnkDownLoadBrowse.submit();
	}
	function FunctionCancel()
	{
		document.FrmBnkDownLoadBrowse.action="WBnkDownLoadSelection.asp";
		document.FrmBnkDownLoadBrowse.submit();
	}	
	</script>
  ...
  <%
	...
	lResult  = lObjBnkDownLoad.DoRbnkBrowse(lStartDate,butAction,Bstatus,lResponse,lRec,lPrevious,lNext)
		%>
	<HTML>
	<HEAD>
		<style>
