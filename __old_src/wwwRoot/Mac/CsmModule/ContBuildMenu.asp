	...
	<%'if lUserType="M" then %>
		<table width="85%" align="center" border=1>
			...
			<tr class=tdbglight height=20 align=left>
				...
				<td><A href="BankView.asp?Mode=V"><font class=blacktext><li>View   Contract Information</font></LI></a></td>
			</tr>
  			<tr class=tdbglight height=20 align=left>
	    		<td><A href="BankUpd.asp"><font class=blacktext><li>Update   Contract Information</font></LI></a></td>
				<td><A href="BankView.asp?Mode=D"><font class=blacktext><li>Delete   Contract Information</font></LI></a></td>
			</tr>
			<!--tr class=tdbglight height=20 align=left>
