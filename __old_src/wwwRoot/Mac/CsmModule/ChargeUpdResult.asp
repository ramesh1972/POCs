...
lResult =lObjCharge.ChargeMasterUpdate(cstr(Request.Form("txthidComgCode")),cstr(request.form("txthidContCode")),cstr(request.form("txthidChrgType")),cstr(Request.Form("optChrgBase")),Request.Form("txtChrgFee")*100,Request.Form("txtChrgAmt")*100,Request.Cookies("UserId"))	 
select case(lResult)
	case "0":
