...
<%
	...
	set lObjubnk	= server.CreateObject("Mac.AtsMgr")
	...
	if Bstatus="V" THEN
	   lResult = lObjUbnk.DoBrowse(("MZE0006000", lmlgusercode, "0001-01-01:00:00:00.000000", ipcuserid, "1001-01-01:00:00:00.000000", ipccompanyno, "IOADDQ", ipctradingcode, lresbuffer, lreccount)
	   ' .DoUsrBnkBrowse(trim(lBankCode),trim(lBranchcode),butAction, Bstatus, lResponse, lRec)
	END IF 
