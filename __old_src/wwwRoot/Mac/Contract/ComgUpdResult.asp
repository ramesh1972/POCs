...
dim lResultValues
dim lResponse
	lComgCode	  = trim(Request.Form("opthidComgCode"))
	lComgDesc	  = trim(Request.Form("txthidComgDesc"))
	lComgShortDesc= trim(Request.Form("txthidComgShortDesc"))
	lExchange	  = trim(Request.Form("opthidExchange"))
	set lObjComg	=	server.CreateObject("Mac.COMgroupMgr")
	lResult =lObjComg.DoUpdate("U",lComgCode,lComgDesc,lComgShortDesc,"N",lexchange)	 
...
<Table width="60%" border="1" cellspacing="1" cellpadding="1">
	...
	<font class=colorboldtext1><%=lResponse%>. Click <a href="ComgMenu.asp">here</a> to view previous page</font>
	</td></tr>
</table>
</center>		
<br><br>
