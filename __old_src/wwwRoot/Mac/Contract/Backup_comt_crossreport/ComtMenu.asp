	...
	<%'if lUserType="M" then %>
		<table width="85%" align="center" border=1>
			...
			<tr class=tdbglight height=20 align=left>
				<td><A href="ComtMaster.asp"><font class=blacktext><li>Add Commodity Type</font></LI></a></td>
			...
			<tr class=tdbglight height=20 align=left>
	    		<td><A href="ViewComts.asp"><font class=blacktext><li>View All Commodity Types</font></LI></a></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	<br><br>
