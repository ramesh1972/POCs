...
'	lUserType=Request.Cookies("UserType")
	...
	var i=fValue;
	if (i==1) {
		document.frmContBuildView.action="ContBuildUpdResult.asp";
...
<%
   ...
   lRespCode = lObjConBuldr.DoBrowse(trim(lConCode),linstcode,lConType,lConGrp,lDesc,lCirFilter,lOCPTrdDuration,lTickSize,lMktLot,lTrdStDate,lTrdEndDate,lMinVal,lDlvdStDate,lDlvdEndDate,lMaop,lOCPTrdCount,lConUnit,lStatus,lSettleFilter,lMinDripQty,lContBasePrice,lExchange,"MAS0001000")
...
%>	
 ...
 <table width="90%" border="0"  cellpadding=1 cellspacing=1 align=center>
	    ...
	    <tr>
	       ...
	       <INPUT name = "txtConCode" value=<%=linstcode%>
	       </td>   
...
<% if Request.Form("txthidMode")="U" then%>
	<tr>
      <td  colspan=4 align=center class="tdbglight">
   		<input type="Button" name="sbtDelChrg"   value="Update    "  onclick ="return btnClick(1);">&nbsp;&nbsp;&nbsp;
...
<center>
		...
		<tr  width="40%"><td class=tdbgdark><font class=whiteboldtext>Contract Information details </font></td></tr>
