...
%>
	...
	function btnClick(fValue)
	{
		...
		if (i==1) {
			...
			if (document.frmContBuildSelection.OptContCode.value==""){
				...
				document.frmContBuildSelection.action="ContBuildUpdRes.asp";
	...
	<tr class="tdbgdark">
	   <td valign=center colspan=2 class="whiteboldtext1">Select Contract Code for Contract Update</td>
	</tr>
   ...
   <input type=hidden name=txthidMode value=<%=Request.QueryString("Mode")%>>		
	 <TR><TD class=tdbglight width=25% height="20"><font class=blacktext>Contract Code</font></TD>
	...
	<%else%>
	 <center><p>  
       <table width="70%" align=center border=0>
				<tr class="tdbgdark"> 
					<td colspan=2 class="whiteboldtext1">Select Contract Code </td>
				</tr>
				<tr class="tdbglight"> 
					<td colspan=2 class="blacktext">No More Contracts  Available for Selection......Click
					<A href="ContBuildMenu.asp">here</A> to view menu 
					</td>
				</tr>		
				<tr><td>&nbsp;</td></tr>
		</table>
