	...
	<%'if lUserType="M" then %>
		<table width="85%" align="center" border=1>
			...
			<tr class=tdbglight height=20 align=left>
				<td><A href="ContBuildMenu.asp"><font class=blacktext><li>Contract Builder</font></LI></a></td>
				<td><A href="ConMainSelection.asp"><font class=blacktext><li>Contract Maintenance </font></LI></a></td>
			</tr>
  			<tr class=tdbglight height=20 align=left>
