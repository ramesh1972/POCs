...
%>
	...
	function btnClick(fValue)
	{
		...
		if (i==1) {
			...
			if (document.frmChargeSelection.OptComgCode.value==""){
				...
				document.frmChargeSelection.action="ComgViewRes.asp";
				document.frmChargeSelection.method="post";
				document.frmChargeSelection.submit(); }}
		else if(i==2) {
			document.frmChargeSelection.action="ComgMenu.asp";
			document.frmChargeSelection.submit(); }
	}
	</script>
	<HTML>
	...
	<tr class="tdbgdark">
	   <td valign=center colspan=2 class="whiteboldtext1">Select the criteria to View Commodity Group</td>
	</tr>
	<%elseif Request.QueryString("Mode")="D" then%>
	<tr class="tdbgdark">
	   <td valign=center colspan=2 class="whiteboldtext1">Select the criteria to Delete Commodity Group</td>
	</tr>
	<%end if%>
	 ...
	 <center><p>  
       <table width="70%" align=center border=0>
				...
				<tr class="tdbglight"> 
					...
					<A href="ComgMenu.asp">here</A> to view menu 
					</td>
				</tr>		
				<tr><td>&nbsp;</td></tr>
		</table>
