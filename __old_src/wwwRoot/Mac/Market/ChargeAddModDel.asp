...
<%
	...
	dim hidActionvalue
		...
		set lObjChgUpdate	= server.CreateObject("CLEARANDSETTLEMENT.ClearSettlement")
		...
		case "1":
			...
			lResult	=	lObjChgUpdate.chargeMasterAdd("MZE0006000",lComgcode,lContCode,lChrgType,lChrgBase,lChrgFee,lChrgAmt)
		...
		<%case "3":
		    ...
		    lResult	=	lObjChgUpdate.ChargeMasMod("MZE0006000",lComgcode,lContCode,lChrgType,lChrgBase,lChrgFee,lChrgAmt)
		...
		<%case "4"	:
		    ...
		    lResult	=	lObjChgUpdate.chargeMasterDel("MZE0006000",lComgcode,lContCode,lChrgType,lChrgBase,lChrgFee,lChrgAmt)
		    select case(left(lresult,instr(lResult,"|")-1))
			case "0":
