...
Dim iNext
	...
	if iNext = "" then iNext = 0
	iNext = iNext + 1
	document.frmAnnotation.txtDest.Value = iNext
	frmAnnotation.Submit
End Sub

Sub cmdPrev_Click()
Dim iPrev
	iPrev = document.frmAnnotation.txtDest.Value
	if iPrev = "" then iPrev = 0
	iPrev = iPrev - 1
	document.frmAnnotation.txtDest.Value = iPrev
	frmAnnotation.Submit
End Sub

Sub Img_Click(iImg)
	document.frmAnnotation.txtDest.Value = iImg
	frmAnnotation.Method="POST"
	frmAnnotation.Action="Annotation.asp"
	frmAnnotation.Submit
...
<SCRIPT Language=javascript>
	...
	parent.frames[0].document.imgQ.src = parent.frames[0].document.imgQsel.src
...
<tr>
<!--<td class=smalltext>Click to see results</td>-->
<%@Language=VBSCRIPT%>
...
<%
	...
	If iQID = 1 then %>
		<table border="0" cellspacing=2 cellpadding=2 class="VB10" align="center" width="100%" background="images/blueback.jpg">
		...
		<!-- Table for Options -->
		<TABLE border="0" cellspacing=2 cellpadding=4  class="smallbody" align="center" width="100%" background="images/blueback.jpg">
		<TR>
		...
		<TR><TD Colspan=3 align=center ><INPUT class=highermenuitem name=cmdNext type=button value="Next >>" onClick="cmdNext_Click()"></TD></tr>
...
<%	ElseIf iQID = 2 then %>
		...
		<TR><TD Colspan=3 align=center >
			<INPUT class=highermenuitem name=cmdPrev type=button value="Prev >>" onClick="cmdPrev_Click()">
			<INPUT class=highermenuitem name=cmdNext type=button value="Next >>" onClick="cmdNext_Click()">
			</TD>
		</TR>
...
<%	ElseIf iQID = 5 then %>
	...
	health plan? (Please check all that apply)</td>
		...
		<!-- Table for Options -->
		<TABLE border="0" cellspacing=4 cellpadding=4  class="smallbody" align="center" width="100%" background="images/blueback.jpg">
...
<%	ElseIf iQID = 6 then %>
		...
		<table border="0" cellspacing=2 cellpadding=2 class="VB10" align="center" width="100%" background="images/blueback.jpg">
		<tr>
			<td>Q6. Generally how likely are to prescribe a brand-name medication based on a
	patient request for each of the following therapeutic categories?</td>
		</tr>
		</TABLE>

		<!-- Table for Options -->
		<TABLE border="1" cellspacing=2 cellpadding=4  class="smallbody" align="center" width="100%" background="images/blueback.jpg">
		<TR >
...
<%	ElseIf iQID = 11 then %>
	...
	for what conditions are they requested?</td>
		...
		<!-- Table for Options -->
		<TABLE border="0" cellspacing=2 cellpadding=4  class="smallbody" align="center" width="100%" background="images/blueback.jpg">
		<table background="images/blueback.jpg">
		<TR>
