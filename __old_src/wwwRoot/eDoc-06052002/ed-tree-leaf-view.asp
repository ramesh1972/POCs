...
%>
					...
					<TR>
					<TD align="right"><A href="ed-tree-leaf-edit.asp?NodeID=<%=lNodeID%>&LeafID=<%=trim(lRs("TL_LeafElementID"))%>&LeafType=Para">Edit Para</A></TD>
					</TR>
					</TABLE>
...
%>
				<TABLE align="center" width=100%>
				<TR>
				<TD align="right"><A href="ed-tree-leaf-edit.asp?NodeID=<%=lNodeID%>&LeafID=<%=trim(lRs("TL_LeafElementID"))%>&LeafType=Break">Edit Breaks</A></TD>
				</TR>
				</TABLE>
<%
