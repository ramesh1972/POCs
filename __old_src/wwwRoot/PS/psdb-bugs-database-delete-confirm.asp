...
<BR>
<form name="frmDatabaseDelete" action="psdb-bugs-database-remove.asp" method="post">
...
<table width="75%" border="1"  cellpadding="0" cellspacing="0" align=center STYLE="border-collapse:collapse">
	<tr class="tdbgdark"> 
      <td valign=center colspan=2><span class="whiteboldtext1">Confirm Bugs Database Delete</span></td>
    </tr>
      ...
      <tr> 
        ...
        <td  align="left" height="16" valign="top" width="60%" class="tdbglight"> 
          <%=trim(lDatabaseRs("DB_Description"))%>
        </td>
      </tr>
</table>
<br>
