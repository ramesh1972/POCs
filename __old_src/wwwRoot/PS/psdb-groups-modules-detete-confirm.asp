...
<BR><br><br>
<BR>
<form name="frmModuleModify" action="psdb-groups-modules-remove.asp" method="post">
...
<table width="75%" border="1"  cellpadding="0" cellspacing="0" align=center STYLE="border-collapse:collapse">
	<tr class="tdbgdark"> 
      <td valign=center colspan=2><span class="whiteboldtext1">Confrim Project Module Deletion</span></td>
    </tr>
      <tr> 
      ...
      <tr> 
        ...
        <td  align="left" height="16" valign="top" width="60%" class="tdbglight"> 
          <%=trim(lModuleRs("M_ModuleDescription"))%>
        </td>
      </tr>
</table>
<br>
<table width="47%" border="0"  cellpadding="0" cellspacing="0" align=center STYLE="border-collapse:collapse">
      <tr> 
        <td colspan=2 valign="center" align=middle> 
            <input type="submit" name="sModify" value="Delete" style='BACKGROUND-COLOR: aqua'>
