...
<%	' Get the employee id and password
	...
	Dim lPriorityID
	Dim lPriority
	Dim lPriorityUpdated
			
	lPriorityUpdated = false
	lPriorityID = Request.Form ("hPriorityID")
	lPriority = Request.Form ("ebPriority")
	
	Set lSBObj = Server.CreateObject ("Bugs.clsSoftwareBugs")
	lPriorityUpdated = lSBObj.UpdatePriority  (eval(lPriorityID), lPriority)
	
	if lPriorityUpdated Then %>
		<TABLE align="center" width=400 class="tdbgdark" STYLE='BORDER-COLLAPSE: collapse'>
		<TR>
			<TD><font class="whiteboldtext">Priority Successfully Updated</font></TD>
		</TR>
		</TABLE>
...
%>
		<TABLE align="center" width=400 class="tdbgdark" STYLE='BORDER-COLLAPSE: collapse'>
		<TR>
			<TD><font class="whiteboldtext">Priority was not Updated</font></TD>
		</TR>
		</TABLE>
