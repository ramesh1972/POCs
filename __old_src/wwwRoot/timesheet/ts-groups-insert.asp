...
<%	' Get the employee id and password
	...
	if lGroupAdded Then %>
		...
		<TR>
			<TD><font class="whiteboldtext">Group Successfully Added</font></TD>
		</TR>
		</TABLE>
...
%>
		<TABLE align="center" width=400 class="tdbgdark" STYLE='BORDER-COLLAPSE: collapse'>
		<TR>
			<TD><font class="whiteboldtext">Group Addition Failed</font></TD>
		</TR>
		</TABLE>

		<TABLE align="center" width=400 border=1 class="tdbglight" STYLE='BORDER-COLLAPSE: collapse'>
		<TR>
			<TD align="center"><A href="ts-groups-add.asp">Click here</A> to go to try again</TD>
		</TR>
		</TABLE>	
<% end if 
