...
#ifndef rvWebBrowserChrome_h__
#define rvWebBrowserChrome_h__
...
class nsXPBaseWindow;
class rvMainWindow;

class rvWebBrowserChrome : public nsIWebBrowserChrome,
...
public:
   rvWebBrowserChrome();
   virtual ~rvWebBrowserChrome();

   void BrowserWindow(nsXPBaseWindow* aBrowserWindow);
   nsXPBaseWindow* BrowserWindow();
