function create_section_bar(section, pos)
{
	...
	if (pos == "top")
	{
		set_section_oi_dimension(bar, 0, 0, w, section.bar_thickness);
	...
	{
		set_section_oi_dimension(bar, 0, h-section.bar_thickness, w, section.bar_thickness);
		bar.min_section_height = section.bar_thickness;
	...
	{
		set_section_oi_dimension(bar, 0, 0, section.bar_thickness, h);
	...
	{
		set_section_oi_dimension(bar, w-section.bar_thickness, 0, section.bar_thickness, h);
		bar.min_section_width = section.bar_thickness;
