...
CXmlPage.prototype.Boot = function () {
    ...
    this.commandBar = add_section(groot_container, "commandBar", 0, 0, g_cw(), 30, commndBarHtml, "dock");
    add_property(this.commandBar, "dock_position", "top");
    add_property(this.commandBar, "min_section_height", "30");
    add_property(this.commandBar, "is_fixed_height", true);

    this.bodySection = add_section(groot_container, "rnr1", 0, 0, 400, 100, "", "dock");
    add_property(this.bodySection, "dock_position", "left");
    add_property(this.bodySection, "bar", "left");

    //this.bodySection = add_section(groot_container, "commandBar", 0, 0, g_cw(), g_ch(), "", "dock");
    //add_property(this.bodySection, "dock_position", "bottom");
...
CXmlPage.prototype.LoadSection = function (parentSection, currentSectionNode) {
    ...
    add_property(thisSection, "bar", "top" /*currentSectionNode.stringAttribute("bar")*/);
...
function onSave() {
    ...
    var win = window.open("", "xmls", "", "self");
    win.document.body.innerHTML = sectionXmls;
    //alert(sectionXmls);
}
