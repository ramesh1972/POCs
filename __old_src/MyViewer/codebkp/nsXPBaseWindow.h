...
public:
  ...
  NS_IMETHOD GetWebShell(nsIDocShell*& aResult);
  ...
  NS_IMETHOD FindWebShellWithName(const PRUnichar* aName, nsIDocShell*& aResult);
...
protected:
  ...
  nsXPBaseWindowType mWindowType;
   ...
   void OnLoadFinished(nsIRequest* aRequest,
