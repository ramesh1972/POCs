...
public:
    ...
    */
    ...
    virtual void MouseClick(nsIDOMEvent* aMouseEvent, nsBrowserWindow * aWindow, PRBool &aStatus) = 0;
    ...
    */
    ...
    virtual void Initialize(nsBrowserWindow * aWindow) = 0;
    ...
    */
    ...
    virtual void Destroy(nsBrowserWindow * aWindow) = 0;
