                      ...
                      PRBool aAllowPlugins)
{
  ...
  r.x=30;
  r.y = 30;
  mWindow1->Create((nsIWidget*) NULL, r, HandleBrowserEvent,
                  nsnull, aAppShell, nsnull, &initData);
  mWindow1->GetClientBounds(r);
  mWindow1->Show(PR_TRUE);
  */
...
nsresult nsBrowserWindow::HandleEvent(nsIDOMEvent* aEvent)
{
	...
	if (s.CompareWithConversion("click") ==0)
			MouseClick(aEvent);
	else if (s.CompareWithConversion("mouseover") == 0)
