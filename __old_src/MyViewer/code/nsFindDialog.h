...
public:
  ...
  virtual void MouseClick(nsIDOMEvent* aMouseEvent, nsBrowserWindow * aWindow, PRBool &aStatus);
  virtual void Initialize(nsBrowserWindow * aWindow);
  virtual void Destroy(nsBrowserWindow * aWindow);
