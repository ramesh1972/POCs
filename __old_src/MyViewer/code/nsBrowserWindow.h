...
public:
  ...
  nsCOMPtr<nsIWidget> mWindow;
    nsCOMPtr<nsIWidget> mWindow1;
	  nsCOMPtr<nsIWidget> mWindow2;
    nsCOMPtr<nsIWidget> mParWindow;
  nsCOMPtr<nsIDocShell> mDocShell;
  nsCOMPtr<nsIDocShell> mDocShell1;
  nsCOMPtr<nsIWebBrowser> mWebBrowser;
  nsCOMPtr<nsIWebBrowser> mWebBrowser1;
  ...
  nsBrowserWindow * mXPDialog;
  nsBrowserWindow * mTableInspectorDialog;
  nsBrowserWindow * mImageInspectorDialog;
    nsBrowserWindow * mFindDialog;
...
protected:
  ...
  nsWebBrowserChrome*   mWebBrowserChrome;
    nsWebBrowserChrome*   mWebBrowserChrome1;
  PRBool mHaveMenuBar;
