<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TestDrive.master" CodeFile="TestDrive.aspx.cs" Inherits="TestDrive" %>

<asp:Content  ContentPlaceHolderID="TestDriveContent" runat=server>
    <script type="text/javascript" language="javascript">
        var myAd =
        {
            adkeywords: "test", addesc: "test adplusplus.com advertisements"
        };
    </script>

    <script type="text/javascript" language="javascript">
        function LoadTest() {
            document.getElementById('TestDrive_TextArea').style.visibility = "hidden";
            document.getElementById('TestDrive_TextArea').style.height = "0px";
            document.getElementById('MockPage').innerHTML = document.getElementById('SampleHTML').value;
            document.getElementById('TestDrive_ContentDiv').style.visibility = "visible"; 
            adpp_LoadAds();
        }
    </script>
<div id='TestDrive_TextArea'>
<table width=100% height=100% class=standard_font border=0>
<tr><td width=40%><B>Enter Test Text/Html:</B></td></tr>
<tr><td height=95%>
<textarea id='SampleHTML' rows=20 cols=10 style='width:99%;height:100%' class=standard_font>
    ...
    desire to secure by Letters Patent, is --</p>
</textarea>
</td></tr>
<tr><td><input type=button value='Load And Highlight Text' style='font-weight:bold;font-size:larger;color:blue' onclick='LoadTest();' /></td></tr>
</table>
</div>
<div id="TestDrive_ContentDiv" style='height:0px;visibility:hidden;border:0px'>
<table width=100% height=100% border=0>
<tr><td ><span style='font-weight:bold;font-size:larger;color:blue'>Test Content Displayed with Highlighted Contextual Words. Move the Mouse Over the Keywords to See Advertisements.</span></td></tr>
<tr><td><div id='MockPage' class=standard_font style='background-color:White'></div></td></tr>
</table>
</div>
</asp:Content>