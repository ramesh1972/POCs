...
function create_tab(tab_bar, for_section)
{
    ...
    var text = create_box_text(tab, "tab_text_" + tab.id, text);
    tab.text = text;
...
function set_tab_text(tab, value) {
    if (tab == null || tab.text == undefined || tab.text == null)
        return;
...
function set_tab_inactive_style(tab)
{
	...
	sss(tab, "backgroundColor", "gray");
	sss(tab, "zIndex", 0);
	
	set_text_direction(tab, "tab_text_" + tab.id, tab.tab_bar.tab_container.tab_position);
	set_text_style(tab, "tab_text_" + tab.id, "arial", "white", 12, "bold",  "gray");	
}
...
function set_tab_active_style(tab)
{
	...
	sss(tab, "backgroundColor", "white");
	sss(tab, "zIndex", 1);

	set_text_direction(tab, "tab_text_" + tab.id, tab.tab_bar.tab_container.tab_position);
	set_text_style(tab, "tab_text_" + tab.id, "arial", "black", 12, "bold", "yellow");	
}
...
function change_tab_id(tab_section)
{
	...
	set_text_style(tab_section.tab, "tab_text_" + tab_section.tab.id, "arial", "white", 12, "bold",  "gray");	
}
