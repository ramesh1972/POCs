...
function adpp_LoadAds() 
{
    ...
    (
        {
            type: "POST",
            url: "http://localhost:1224/adpp/PubSubAds.ashx",
            data: myAdStr,
...
function ShowAd(adlink, adkeyword, addesc) 
{
    ...
    var bndRight = rect_a.right + getBody().scrollLeft;
    var bndBottom = rect_a.bottom + getBody().scrollTop;
    ...
    // adplusplus.com
    adhtml = "<span style='font-size:11;font-weight:bold;color:green'>Free ads by <a href=#>adPlusPlus.com</A></span>";
...
function HighlightAdWords1(adsJson) 
{
    ...
    {
        var highlightStartTag = "<a id='a_" + adsJson.ads[i].adkeyword + "' href=# style='color:green" + "; background-color:pink" + ";' onmouseover='ShowAd(\"" + adsJson.ads[i].adlink + "\",\"" + adsJson.ads[i].adkeyword + "\",\"" + adsJson.ads[i].adlinkdesc + "\");'" + ">";
