...
function rock_and_roll_tabs() {
    ...
    var section11 = add_section(section1, "rnr11", 0, 0, 400, 400, "", "tab");
    add_property(section11, "tab_position", "top");
    ...
    var section21d = add_section(section11, "rnr21d", 0, 0, g_cw(), g_ch(), "", "tab");
    add_property(section11, "dock_position", "left");
    add_property(section11, "bar", "bottom");

    var section21 = add_section(section21d, "rnr11", 0, 0, 400, 400, "", "tab");
    add_property(section11, "tab_position", "left");
    add_property(section11, "bar", "bottom");
...
{
    var section2 = create_docking_section(groot_container, "1", 0, 0, 200, 400, "", "top", "view", true);
	    var section1 = create_docking_section(section2, "2", 0, 320, 500, 430, "", "left", "view", true);
	        create_docking_section(section1, "3", 0, 0, 503, 330, "", "left", "view", true);
	        create_docking_section(section1, "4", 0, 0, 503, 330, "", "right", "view", true);
}
...
function simple_tabs()
{
    section2 = add_section(groot_container, "st_2", 0, 0, 300, 300, "", "dock");
		add_property(section2, "dock_position", "right");

		section3 = add_section(section2, "st_3", 0, 0, 400, 300, "", "tab_node", "Music");
		    add_property(section3, "tab_position", "right");
		    add_section(section2, "st_3", 0, 0, 400, 300, "", "tab_node", "Music");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_301", 0, 0, 400, 300, "", "tab_node", "Music1");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_302", 0, 0, 400, 300, "", "tab_node", "Music2");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_303", 0, 0, 400, 300, "", "tab_node", "Music3");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_304", 0, 0, 400, 300, "", "tab_node", "Music4");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_305", 0, 0, 400, 300, "", "tab_node", "Music5");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_306", 0, 0, 400, 300, "", "tab_node", "Music6");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_307", 0, 0, 400, 300, "", "tab_node", "Music7");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_308", 0, 0, 400, 300, "", "tab_node", "Music8");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_309", 0, 0, 400, 300, "", "tab_node", "Music9");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_310", 0, 0, 400, 300, "", "tab_node", "Music10");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_311", 0, 0, 400, 300, "", "tab_node", "Music11");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_312", 0, 0, 400, 300, "", "tab_node", "Music12");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_313", 0, 0, 400, 300, "", "tab_node", "Music13");
		    add_property(section3, "tab_position", "right"); add_section(section2, "st_314", 0, 0, 400, 300, "", "tab_node", "Music14");
		    add_property(section3, "tab_position", "right");
		section13 = add_section(section2, "st_13", 0, 0, 400, 300, "", "tab_node", "Photos");
		    add_property(section13, "tab_position", "right");
            
		    section22 = add_section(section3, "st_22", 0, 0, 400, 300, "", "tab_node", "English");
		        add_property(section22, "tab_position", "left");

	        section23 = add_section(section3, "st_23", 0, 0, 400, 300, "", "tab_node", "Tamil");
		        add_property(section23, "tab_position", "left");

		        section221 = add_section(section22, "st_221", 0, 0, 400, 300, "", "tab_node", "Pink Floyd");
		            add_property(section221, "bar", "top");
		            add_property(section221, "tab_position", "top");

	            section222 = add_section(section22, "st_222", 0, 0, 400, 300, "", "tab_node", "Grateful Dead");
		            add_property(section222, "bar", "top");
		            add_property(section222, "tab_position", "top");

		    section4 = add_section(section3, "sc_4", 0, 0, 150, 150, "", "tab_node", "Devotional");
		        add_property(section4, "bar", "right");
		        add_property(section4, "dock_position", "top");

		        section5 = add_section(section4, "sc_5", 0, 0, 100, 100, "", "tab_node", "Sai Aarathis");
		            add_property(section5, "bar", "left");
		            add_property(section5, "tab_position", "top");

		            section42 = add_section(section4, "sc_42", 0, 0, 100, 100, "", "tab_node", "Vishu Sahasranamam");
		            add_property(section42, "bar", "left");
		            add_property(section42, "tab_position", "top");

//		                section6 = add_section(section5, "sc_6", 0, 0, 150, 150, "", "dock");
//		                add_property(section6, "bar", "right");
//		                add_property(section6, "dock_position", "top");
//		                add_property(section6, "tab_text", "tab1.1.1.1");

//		                    section7 = add_section(section6, "sc_7", 0, 0, 100, 100, "", "tab", "test_tab_7");
//		                    add_property(section7, "bar", "left");
//                            add_property(section7, "tab_position", "bottom");

//                            section8 = add_section(section6, "sc_8", 0, 0, 100, 100, "", "tab", "test_tab_8");
//                            add_property(section8, "bar", "left");
//                            add_property(section8, "tab_position", "bottom");

//                                section9 = add_section(section8, "sc_9", 0, 0, 150, 150, "", "dock");
//                                add_property(section9, "bar", "right");
//                                add_property(section9, "dock_position", "top");
//                                add_property(section9, "tab_text", "test_tab_9");

//                                    section10 = add_section(section9, "sc_10", 0, 0, 100, 100, "", "tab", "test_tab_10");
//                                    add_property(section10, "bar", "left");
//                                    add_property(section10, "tab_position", "left");

//                                        section11 = add_section(section10, "sc_11", 0, 0, 150, 150, "", "dock");
//                                        add_property(section11, "bar", "right");
//                                        add_property(section11, "dock_position", "top");
//                                        add_property(section11, "tab_text", "test_tab_11");

//                                        section12 = add_section(section11, "sc_10", 0, 0, 100, 100, "", "tab", "test_tab_12");
//                                        add_property(section12, "bar", "left");
//                                        add_property(section12, "tab_position", "right"); 
		            //                                    
...
function simple_floats()
{
	...
	section5 = add_section(groot_container, "sf_5", 150, 30, 300,200, "", "float");
		add_property(section5, "bar", "right");
...
//		add_section_bar(section1, "bottom");
	...
	section2 = create_docking_section(groot_container, "2", 300, 250, 600,250, "", "view", true);
//			create_docking_section(section2, "6", 100, 200, 100,100, "", "left","view", true);
	//		section3 = create_docking_section(section2, "8", 100, 100, 100, 100, "", "top","view", true);
			//create_docking_section(section2, "7", 0, 0, 100, 100, "", "top","view", true);
...
function simple_all_double_dock()
{
	...
	create_docking_section(groot_container, "3", 0,0,200, 200, "", "right","view", true);		
	create_docking_section(groot_container, "4", 0,0,100,300, "", "bottom","view", true);
	create_docking_section(groot_container, "5", 0,0,100,100, "", "left", "view", true);
	create_docking_section(groot_container, "6", 0,0,380,100, "", "top", "view", true);
	create_docking_section(groot_container, "7", 0,0,200, 200, "", "right", "view", true);		
	create_docking_section(groot_container, "8", 0,0,100,300, "", "bottom", "view", true);
}

function simple_all_contained_dock()
{
	section1 = create_docking_section(groot_container, "1", 0,0,200,50, "", "left","view", false);
			   create_docking_section(groot_container, "2", 0,0,100,160, "", "top","view", false);
	section2 = create_docking_section(groot_container, "3", 0,0,200,10, "", "right","view", false);
			   create_docking_section(groot_container, "4", 0,0,30, 200, "", "bottom","view", true);		
			   create_docking_section(groot_container, "5", 0,0,50,100, "", "bottom","view", true);
			   create_docking_section(groot_container, "6", 0,0,100,50, "", "top","view", false);


		       create_docking_section(section1, "7", 0,0,100,100, "", "left","view", false);
		       
		       create_docking_section(section1.parent_section, "8", 0,0,120,260, "", "top","view", true);
			   create_docking_section(section2, "9", 0,0,100, 100, "", "left","view", true);		
}
...
function create_complex_docks()
{
	...
	section3 = create_docking_section(groot_container, "3", 0,0,100,100, "", "right","view", false);
	section3 = create_docking_section(groot_container, "4", 0,0,100,100, "", "right","view", false);
	section4 = create_docking_section(groot_container, "5", 0,0,100,100, "", "right","view", false);
	
	section5 = create_docking_section(section1, "6", 0,0,390,100, "", "bottom","view", false);
	create_docking_section(section2, "7", 0,0,390,70, "", "left","view", false);
	create_docking_section(section5, "8", 0,0,30,50, "", "top","view", false);
	section4 = create_docking_section(groot_container, "9", 0,0,100, 100, "", "top","view", false);		
	section2 = create_docking_section(groot_container, "10", 0,0,180,80, "", "top","view", false);
	...
	section4 = create_docking_section(section1, "52", 0,0,150,90,"", "left","view", false);
	section5 = create_docking_section(section4, "53", 0,0,70,80,"", "left","view", false);
	section5 = create_docking_section(section4.parent_section, "63", 0,0,10,80,"", "top","view", true);
	section5 = create_docking_section(section5, "73", 0,0,70,80,"", "bottom","view", false);
	create_docking_section(section1.parent_section, "83", 0,0,60,90,"", "top","view", false);
	create_docking_section(section1.parent_section, "93", 0,0,60,90,"", "bottom","view", false);

	create_docking_section(section2, "54", 0,0,80,100,"", "left","view", false);
	
	section7 = create_docking_section(section2.parent_section, "64", 10,0,90,80,"", "top",  "view", true);
...
//create_single_ld("ram");
//create_double_ld("ram");
//create_triple_ld("ram");
//create_double_td();
//simple_docks();
//create_dockset_ld_complex();
//simple_all_double_dock();
//simple_all_contained_dock();
...
simple_tabs();
//rock_and_roll();
//simple_docks_in_floats();

gpage_initialization = true;
